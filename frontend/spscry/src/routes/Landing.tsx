            ...
            <div className="glass glass-container">
                <div className="flex justify-center">
                    <div className="flex flex-col justify-center items-center">
                        <h3 className="mb-8 bold text-white text-lg">ScryBall</h3>
                        <p
                        ...
                        >
                            ...
                            other sports. Here's how it works: when you're ready to place a bet, you
                            simply indicate the specific game (using the gameId), and your
                            prediction for the winning team. Our smart contract (SC) takes it from
                            there, employing Scry to fetch the necessary data to process your bet.
                            After the conclusion of the game, the smart contract utilizes Scry once
                            more to verify the game's outcome. Winners are then determined, and
                            winnings are distributed accordingly. This process ensures a
                            transparent, efficient, and trustless betting environment for all users.
                        </p>
